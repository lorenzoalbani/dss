...
def duplicate_tables_for_ssis(conn):
    """
    Uso 'SELECT * INTO ... WHERE 1=0' per copiare solo le colonne e i tipi di dato senza le righe
    """
    ...
    try:
        for table in tables:
            ...
            # L'ordine di drop non è critico qui perché SELECT INTO non crea foreign keys
            try:
